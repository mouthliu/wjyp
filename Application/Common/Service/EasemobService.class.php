...
class EasemobService extends BaseService{
	...
	public $org_name;
	public $app_name;
	public $url = 'https://a1.easemob.com';

	public function __construct()
	{
		$this->client_id     = 'YXA6kF9KMILyEeeQand1V2U-jg';
		$this->client_secret = 'YXA6PJPq1eqmga6woqUmHCX44ncgpX8';
		$this->org_name      = '1132170721115445';
		$this->app_name      = 'wjyp';
		$this->url = $this->url.'/'.$this->org_name.'/'.$this->app_name.'/';
	}

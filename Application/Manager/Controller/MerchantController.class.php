...
class MerchantController extends BaseController {
    ...
    function doAdd(){
        ...
        if(!empty($_POST['enterprise_end_time'])){
            $_POST['enterprise_end_time'] = strtotime($_POST['enterprise_end_time']);
        }else{
            $_POST['enterprise_end_time'] = 0;
        }
        if(!empty($_POST['enterprise_start_time'])){
            $_POST['enterprise_start_time'] = strtotime($_POST['enterprise_start_time']);
        }
        if(!empty($_POST['enterprise_establish_time'])){
            $_POST['enterprise_establish_time'] = strtotime($_POST['enterprise_establish_time']);
        }

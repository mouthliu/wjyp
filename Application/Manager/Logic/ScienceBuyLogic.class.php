 ...
 * 商品
 */
class ScienceBuyLogic extends BaseLogic {
    ...
    function getList($request = array()) {
        ...
        $result = D('ScienceBuy')->getList($param);
        return $result;
    }
    ...
    function findRow($request = array()) {
        ...
        $row = D('ScienceBuy')->findRow($param);
        ...
        //处理图片
        $row['ScienceBuy_img'] = api('System/getFiles',array($row['ScienceBuy_img']));
        return $row;
    }
...
//        $data['end_time']   = strtotime($data['end_time']);
    ...
    function addScienceBuyGoods($request = array()){

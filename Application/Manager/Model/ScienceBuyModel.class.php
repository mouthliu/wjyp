 ...
 * 管理员模型
 */
class ScienceBuyModel extends BaseModel {
...
//        array('bid_time', 'time', self::MODEL_BOTH, 'function'),
    ...
    function getList($param = array()) {
        ...
        $model  = $this->alias('goods')
            ->field('goods.*,g.goods_name,g.merchant_id,g.merchant_name,g.shop_price,g.goods_num,g.click_num,g.goods_sn,g.cat_id,g.brand_name')

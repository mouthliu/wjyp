...
return array(
    /* 数据缓存设置 */
    'DATA_CACHE_PREFIX' => 'wjyp_merchant_', // 缓存前缀
    ...
    /* SESSION 和 COOKIE 配置 */
    'SESSION_PREFIX' => 'wjyp_merchant', //session前缀
    'COOKIE_PREFIX' => 'wjyp_merchant_', // Cookie前缀 避免冲突
    ...
    'LOAD_EXT_FILE' => '',
    'BAIDU_MAP_AK' => 'k6ze7mjLHbrbNdMqfbuo9x3x0xfRCpG2',//启用时候请换成申请的百度AK
    //是否开发者模式
    'IS_DEVELOPER' => false,
